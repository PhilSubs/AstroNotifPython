...
print "Lecture des parametres du fichier parameters_run.json"
...
print "Calcul des ephemerides"
theEphemeridesData.computeEphemeridesForPeriod(theParameters, theCalendar)
print "Generation de la page HTML et du bitmap"
...
print "La page HTML et le bitmap sont generes dans " + theParameters.getGlobalPathToWWWFolder() + '/'

# Prepare email for daily notification
if len(theParameters.getNightlyBatchEmailAddress()) > 0:
    print "Preparation a l'envoi du mail"
