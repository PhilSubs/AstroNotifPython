...
class EphemeridesSunMeeus(toolObjectSerializable):
    def __init__(self):
    ...
    def computeEphemerides(self, sDate, sTime):
    ...
    def getObliqEclipInDeg(self):              return self._oMeeusAlgorithm.getMeanObliquityEcliptic()
    def getSunDistInKm(self):                  return self._oMeeusAlgorithm.getSunDistanceInKm()
    def getSunDistInUA(self):                  return self._oMeeusAlgorithm.getSunDistanceInUA()
    def getMeanAnoInDeg(self):                 return self._oMeeusAlgorithm.getSunMeanAnomaly()
    def getApparentGeometricLongitude(self):   return self._oMeeusAlgorithm.getSunApparentGeometricLongitude()
    def getEquationCenter(self):               return self._oMeeusAlgorithm.getSunEquationCenter()
    def getGeometricMeanLongitude(self):       return self._oMeeusAlgorithm.getSunGeometricMeanLongitude()
    def getTrueAnoInDeg(self):                 return self._oMeeusAlgorithm.getSunTrueAnomaly()
    def getTrueGeometricLongitude(self):       return self._oMeeusAlgorithm.getSunTrueGeometricLongitude()
