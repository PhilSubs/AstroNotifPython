...
class ParametersLunarFeatures(toolObjectSerializable):
    ...
    def __initWithData(self, dicJSONData):
        ...
        for iId in range (0, len(dicJSONData)):
            ...
            newLunarFeature = ParametersLunarFeature(iId, dicJSONData[sLunarFeatureKey]["ID"], dicJSONData[sLunarFeatureKey]["Name"], dicJSONData[sLunarFeatureKey]["Longitude"], dicJSONData[sLunarFeatureKey]["LongitudeMin"], dicJSONData[sLunarFeatureKey]["LongitudeMax"], dicJSONData[sLunarFeatureKey]["Latitude"], dicJSONData[sLunarFeatureKey]["IsFavourite"], dicJSONData[sLunarFeatureKey]["Type"], dicJSONData[sLunarFeatureKey]["Height"], dicJSONData[sLunarFeatureKey]["Diameter"], dicJSONData[sLunarFeatureKey]["Depth"], dicJSONData[sLunarFeatureKey]["Length"], dicJSONData[sLunarFeatureKey]["Breadth"],  dicJSONData[sLunarFeatureKey]["Rukl"])
