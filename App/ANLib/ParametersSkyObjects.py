...
class ParametersSkyObjects(toolObjectSerializable):
    ...
    def __initWithData(self, dicJSONData):
        ...
        for iId in range (0, len(dicJSONData)):
            ...
            newSkyObject = ParametersSkyObject(iId, dicJSONData[sObjectKey]["Category"], dicJSONData[sObjectKey]["ID"], dicJSONData[sObjectKey]["Type"], dicJSONData[sObjectKey]["Name"], dicJSONData[sObjectKey]["RA"], dicJSONData[sObjectKey]["Dec"], dicJSONData[sObjectKey]["PictureName"], dicJSONData[sObjectKey]["Comment1"], dicJSONData[sObjectKey]["Comment2"], dicJSONData[sObjectKey]["Distance"], dicJSONData[sObjectKey]["DistanceUnit"], dicJSONData[sObjectKey]["DimensionX"], dicJSONData[sObjectKey]["DimensionXUnit"], dicJSONData[sObjectKey]["DimensionY"], dicJSONData[sObjectKey]["DimensionYUnit"], dicJSONData[sObjectKey]["ApparentMagnitude"], dicJSONData[sObjectKey]["IsFavourite"] )
